...
一般意义上的![“呼叫跟踪”是来自此类公司的产品](assets/other-resources-6.png)
...
![通过集成，您可以看到Web会话实际上是](assets/other-resources-4.png)

## 工作原理 {#how-it-works}

CallTrackingMetrics必须完成一些开发工作才能使其正常工作。 通过使用它们放置在网站上的JavaScript，CallTrackingMetrics可以从[!DNL Marketo Measure] Cookie中获取`_biz_uid`。 然后，CallTrackingMetrics存储此“BizibleId”。
...
![以下是BizibleId为](assets/other-resources-5.png)的任务记录的示例
...
![已从](assets/marketo-engage-activities-01.png)中从任务提取接触点类型“呼叫”
...
Marketo Measure通常推送的![接触点类型值是Web访问，](assets/other-resources-1.png)
...
![如果存在值，请注意，我们只考虑所有Web](assets/other-resources-2.png)
