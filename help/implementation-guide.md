...
了解有关[Marketo Measure Ultimate](/help/migration-from-tier-to-marketo-measure-ultimate.md){target="_blank"}的更多信息。
...
![从源中，选择“添加数据使用模板”](assets/marketo-guide-2.png)

* 选择一个帐户和所有B2B模板，以创建十个标准B2B架构。

![选择一个帐户和所有B2B模板以创建10个标准B2B](assets/marketo-guide-3.png)
...
1. 将字段从Source映射到架构。
   ...
   >[!NOTE]
   >
   >[Marketo Measure Ultimate数据完整性要求](/help/data-integrity-requirement.md){target="_blank"}
...
![用户可以映射来自不同来源的阶段。](assets/marketo-guide-5.png)

如果未映射阶段，系统将无法正常运行，因为没有位置可供数据访问。

如果您是Marketo Measure Ultimate客户，并且已将您的默认功能板对象设置为联系人，请不要使用以下两个特定于潜在客户的字段（[在此了解详情](/help/data-integrity-requirement.md){target="_blank"}）。
