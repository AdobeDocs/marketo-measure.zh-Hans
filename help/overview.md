...
![Marketo Measure层1-3](assets/marketo-overview-1.png)
...
![营销人员应带来其B2B数据(例如，帐户、机会、](assets/marketo-overview-2.png)
...
![来自给定数据的给定实体（例如，帐户）的数据](assets/marketo-overview-6.png)
...
![funnel与回旋镖与自定义模型无选择项。 所有阶段均为](assets/marketo-overview-4.png)

Campaign成员接触点规则和活动接触点规则特定于数据集。

![Campaign成员接触点规则和活动接触点规则特定于数据集。](assets/marketo-overview-5.png)

![Campaign成员接触点规则和活动接触点规则特定于数据集。](assets/marketo-overview-8.png)
