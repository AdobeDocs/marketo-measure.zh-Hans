---
description: 在Microsoft Dynamics CRM中安装和配置Marketo Measure包的分步指南
...
1. 选择 [!UICONTROL Credentials] 或 [!UICONTROL OAuth]。
   ...
   >[!NOTE]
   >
   >有关OAuth的详细信息，请访问[本文](/help/oauth-with-azure-active-directory-for-dynamics-crm.md)。 如果您对流程有任何疑问，请联系您的[!DNL Marketo Measure]客户代表。
