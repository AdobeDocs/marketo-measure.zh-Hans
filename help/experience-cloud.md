...
![如果您已登录Adobe Experience Cloud产品，](assets/unified-overview-6.png)
...
[管理 [!DNL Marketo Measure] 域](/help/domain-management.md)，无需[!DNL Marketo Measure]的帮助。

![无需Marketo Measure的帮助即可管理您的Marketo Measure域(/help/domain-management.md)。](assets/unified-overview-9.png)

**集成帮助中心**

搜索支持文章、提交票证、提供反馈，所有这些都可在[!DNL Marketo Measure]应用程序中找到。

![搜索支持文章、提交票证、提供反馈，所有这些都可以从](assets/unified-overview-5.png)中进行

**应用程序切换器**

那些有权访问多个Adobe产品的用户可以在这些产品之间轻松切换。

![能够访问多个Adobe产品的用户可以轻松切换](assets/unified-overview-4.png)
...
![直接查看特定于产品的通知和Adobe产品的一般公告并与之交互](assets/unified-overview-11.png)

**Adobe 设置**

要更改您的语言或其他Adobe范围的首选项，请单击您的配置文件图标。 您还可以通过单击[!DNL Marketo Measure]我的设置&#x200B;**进行特定于**&#x200B;的更改。

![要更改您的语言或其他Adobe范围的首选项，请单击您的配置文件图标。](assets/unified-overview-8.png)
