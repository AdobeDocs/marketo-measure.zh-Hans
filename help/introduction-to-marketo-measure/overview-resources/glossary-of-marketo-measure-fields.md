...
description: Marketo Measure字段词汇表 — Marketo Measure — 产品文档
...
本文提供了从Marketo Measure基础包添加到Salesforce的所有Marketo Measure字段的术语表。 您还会找到有关可在其中找到字段的对象以及如何使用信息填充每个字段的信息。
...
**Salesforce营销活动** | Buyer Touchpoint、Buyer Attribution Touchpoint
