...
[单击此处直接导航到说明。](/help/marketing-channel-costs.md)
...
[单击此处直接导航到常见问题解答。](/help/marketing-channel-costs.md)
...
![转到“我的帐户”菜单，单击“设置”，然后单击](assets/spend-management-4.png)

**步骤2：下载当前成本CSV**

导航到屏幕右侧并单击&#x200B;**[!UICONTROL Download Current Costs]。**&#x200B;此选项允许您下载CSV格式的电子表格。

![导航到屏幕右侧，然后单击“下载当前版本”](assets/spend-management-1.png)
...
![例如，将Facebook表示为子渠道，将social表示为](assets/spend-management-2.png)
