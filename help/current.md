---
description: 面向Marketo Measure用户的最新发行说明指南
title: 最新发行说明
...
![您现在可以使用营销活动和营销活动成员字段创建区段](assets/release-notes-2.png)
...
* 新文档： [处理CRM导出的设置时出错](/help/configuration-and-setup/crm-error-handling.md)
...
如去年所宣布的，我们将逐步停止向Lead/Contact对象[导出作业，以简化我们的集成，并消除导出到Salesforce标准对象的需要。 ](https://nation.marketo.com/t5/employee-blogs/marketo-measure-salesforce-lead-and-contact-field-deprecation-06/ba-p/350179){target="_blank"}您可以按照此处介绍的步骤[从接触点对象获取相同的数据](/help/2023.md){target="_blank"}。 我们还将共享有关创建工作流的文档，以将此数据添加到Lead/Contact对象。 弃用将于2024年6月14日生效。
...
我们很高兴地介绍新的[归因机会信息板](/help/attributed-opportunity-dashboard.md){target="_blank"}，它旨在让您全面了解您的营销工作如何促进新生的和成熟的管道机会。 利用此仪表板，您可以深入了解可归属于您的策略的每个未结和已结业务机会的详细信息，并灵活地按业务机会阶段进行筛选。 它提供了有关哪些渠道、子渠道或营销活动在归因机会数量方面排名最高的见解，并显示归因机会总数以及归因的未结和已结机会计数。
...
* [回车族阶段和接触点](/help/channel-tracking-and-setup/boomerang-stages-and-touchpoints.md){target="_blank"}
* [设置回车族阶段](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md){target="_blank"}
* [Boomerang阶段方案](/help/channel-tracking-and-setup/boomerang-stage-scenarios.md){target="_blank"}
...
为了帮助您适应此更改，[我们创建了文档](/help/configuration-and-setup/error-notifications.md){target="_blank"}，其中提供了清晰的错误描述和全面的故障排除步骤。
