...
* [自走式暂存器和接触点](/help/channel-tracking-and-setup/boomerang-stages-and-touchpoints.md){target="_blank"}
* [设置回访单阶段](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md){target="_blank"}
* [回音廊舞台场景](/help/channel-tracking-and-setup/boomerang-stage-scenarios.md){target="_blank"}
