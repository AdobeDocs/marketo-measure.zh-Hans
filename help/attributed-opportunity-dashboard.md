...
![上个月按渠道划分的已归因机会金额明细是多少？](assets/attributed-dashboard-3.png)
...
![单击每个渠道旁边的+图标以显示划分依据](assets/attributed-dashboard-1.png)
...
![单击分支以更深入地了解后续层次结构层。](assets/attributed-dashboard-2.png)
