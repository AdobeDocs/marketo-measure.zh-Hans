---
description: 面向Marketo Measure用户的错误通知指南
title: 错误通知
...
![要在Marketo Measure中查看完整的通知消息，请单击“查看”](assets/adobe-setup-1.png)
...
可以在此处<a href="https://admin.salesforce.com/blog/2023/what-is-a-record-triggered-flow#:~:text=A%20record%2Dtriggered%20flow%20allows,is%20created%20and%2For%20updated">找到有关流触发器</a>的Salesforce文档。
    ...
    <tr>
      ...
      <td>查看导致插入/更新失败的触发器代码。 有关触发器的更多详细信息，请参阅以下Salesforce文档：
        ...
        <p>
        为<a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">Marketo Measure用户</a>提供所有必要的权限。
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>从<a href="https://trailhead.salesforce.com/content/learn/modules/validation-rules/bypass-your-validation-rules">自定义验证规则</a>中排除Marketo Measure专用用户。
          </li>
        </ul>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>有关Experience League所需权限的指导，请参阅以下<a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">Marketo Measure文章</a>。</td>
    </tr>
    <tr>
      ...
      <td>请参阅以下帮助文章以确保正确配置：
        <ul>
          <li>
            <a href="/help/adobe-analytics.md">Marketo Measure与Adobe Analytics的集成</a>
          </li>
          <li>
    ...
    <tr>
      ...
      <td>我们需要对以“bizible2__”为前缀的所有字段具有读写权限。 这些字段的完整列表可在本文<a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">中找到</a>。</td>
    </tr>
    <tr>
    ...
    SystemModstamp，IsDeleted，WhoId，bizible2__Bizible_Touchpoint_Date__c</td>
      ...
      <td>有关Marketo Measure所需的权限的指导，请参阅以下帮助文章：
        <ul>
          <li><a href="/help/marketo-measure-dynamics-schema.md">动态</a>
          </li>
    ...
    <tr>
      ...
      <td>此错误有几个特定于Salesforce组织的原因。 以下是一些可以解决此问题的常见故障排除步骤：
        <ul>
          <li>查看每个<a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">对象和字段</a>所需的所有权限。</li>
          <li>从<a href="https://trailhead.salesforce.com/content/learn/modules/validation-rules/bypass-your-validation-rules">自定义验证规则</a>中排除Marketo Measure专用用户。</li>
          <li>授予Marketo Measure“<a href="https://developer.salesforce.com/docs/atlas.en-us.securityImplGuide.meta/securityImplGuide/users_profiles_view_all_mod_all.htm">修改所有</a>”权限。</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <p>
      有关“查看所有数据”权限<a href="https://developer.salesforce.com/docs/atlas.en-us.securityImplGuide.meta/securityImplGuide/users_profiles_view_all_mod_all.htm">的更多信息，请参阅此处</a>。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>禁用Salesforce组织中的限制选取列表设置。
          <p>
          从<a href="https://trailhead.salesforce.com/content/learn/modules/validation-rules/bypass-your-validation-rules">自定义验证规则</a>中排除Marketo Measure专用用户。
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>将您的包升级到最新版本：
        <ul>
          <li><a href="/help/configuration-and-setup/best-practices-for-marketo-measure-crm-package.md">最佳实践</a>
          </li>
          <li><a href="/help/microsoft-dynamics-crm-installation-guide.md">动态</a>
          </li>
