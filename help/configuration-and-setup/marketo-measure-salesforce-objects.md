...
![Marketo Measure对象与特定标准Salesforce对象相关。 此](assets/bizible-full-1.png)
...
![BT对象在潜在客户和联系人页面上显示为](assets/bizible-taxonomy-1.png)
...
![Marketo Measure人员对象关联潜在客户和联系人对象](assets/connect-salesforce-2.png)
...
![如果您通过Optimizly或VWO (Visual](assets/marketo-salesforce-8.png))运行A/B测试
