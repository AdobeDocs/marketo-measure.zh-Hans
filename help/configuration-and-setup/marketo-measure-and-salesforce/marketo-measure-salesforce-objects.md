...
由[!DNL Marketo Measure] JavaScript捕获的数据将被推送到[!DNL Marketo Measure]对象内的自定义[!DNL Marketo Measure]字段中。 某些字段仅存在于某些对象中。 您可以查看[[字段]&#x200B;[!DNL Marketo Measure]的](/help/introduction/glossary.md)词汇表以及相关[对象 [!DNL Marketo Measure] 的](/help/configuration-and-setup/marketo-measure-and-salesforce/marketo-measure-object-and-field-taxonomy.md)可视化图表。
