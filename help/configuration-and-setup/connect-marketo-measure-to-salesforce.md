---
description: 将Marketo Measure连接到Marketo Measure用户的Salesforce指南
...
1. 在左侧的设置选项列中，单击&#x200B;**[!UICONTROL Connections]**&#x200B;部分下的[!UICONTROL Integrations]。
   ...
   ![1. 在左侧的设置选项列中，单击](assets/bizible-full-1.png)

1. 在“连接”中的CRM部分下，单击&#x200B;**[!UICONTROL Set Up New CRM Connection]**。

   ![1. 在“连接”中的CRM部分下，单击“设置新](assets/bizible-taxonomy-1.png)”

1. 此时会出现一个弹出窗口，要求您选择CRM连接。 单击&#x200B;**[!UICONTROL Connect]**&#x200B;徽标旁边的[!DNL Salesforce]。

   ![1. 此时会出现一个弹出窗口，要求您选择CRM连接。 单击](assets/connect-salesforce-1.png)
...
![您可以在Marketo Measure中通过我的帐户设置访问此限制](assets/connect-salesforce-2.png)
...
1. 单击“锁定”图标以进行编辑。
   ...
   ![1. 单击“锁定”图标以进行编辑。](assets/connect-salesforce-3.png)

1. 输入等于或大于100,000的所需限制。 完成后单击&#x200B;**保存**。

   ![1. 输入等于或大于100,000的所需限制。 单击](assets/connect-salesforce-1.png)
