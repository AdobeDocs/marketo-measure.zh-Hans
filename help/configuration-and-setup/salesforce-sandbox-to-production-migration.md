...
* 有关与[!DNL Marketo Measure]的[!DNL Salesforce]关系的详细信息，请参阅[本文](/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md)
...
[页面布局](/help/configuration-and-setup/page-layout-instructions.md)
...
[自定义工作流（如果适用）](/help/channel-tracking-and-setup/using-a-custom-revenue-amount-field.md)
