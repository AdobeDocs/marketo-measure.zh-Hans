...
![Marketo Measure开箱即用地提供帐户ID映射。 此](assets/adobe-setup-1.png)
...
![当大多数客户端使用帐户ID映射时，Marketo Measure可以查找](assets/adobe-setup-2.png)
...
![除了简单地查看机会的联系人角色之外，Marketo](assets/adobe-setup-3.png)
