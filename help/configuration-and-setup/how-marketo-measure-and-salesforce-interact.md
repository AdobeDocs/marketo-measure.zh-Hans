---
description: 概述Marketo Measure如何与Salesforce交换数据，包括导出权限和批次设置
...
![如果未安装Marketo Measure Salesforce包，](assets/bizible-full-1.png)
...
![默认情况下，Marketo Measure每个API点数导出200条记录，每个](assets/bizible-taxonomy-1.png)
