...
1. 为所有用户&#x200B;**[!UICONTROL Install]选择**。
   ...
   ![1. 为所有用户选择“安装”。](assets/bizible-full-1.png)

1. 安装完成后，即可进行查看。

   ![1. 安装完成后，您可以查看它。](assets/bizible-taxonomy-1.png)

完成安装后，您可以根据需要使用[[!DNL Salesforce] 字段更新](/help/configuration-and-setup/page-layout-instructions.md){target="_blank"}页面布局[!DNL Marketo Measure]。

>[!NOTE]
>
>了解[!DNL Marketo Measure]权限集创建情况和[它们的使用方式](/help/configuration-and-setup/marketo-measure-permission-sets.md){target="_blank"}。
...
>
>* [Adobe Admin Console安装程序](/help/configuration-and-setup/adobe-admin-console-setup.md){target="_blank"}
