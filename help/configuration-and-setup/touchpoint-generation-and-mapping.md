---
description: 面向Marketo Measure用户的接触点生成和映射指南
title: 接触点生成和映射
...
>[!MORELIKETHIS]
>
>* [将在线接触点映射到 [!DNL Marketo Measure] 渠道/子渠道](/help/channel-tracking-and-setup/online-custom-channel-setup.md)
>* [从SFDC同步CRM营销活动](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)
>* [正在从 [!DNL Marketo Measure]](/help/channel-tracking-and-setup/custom-campaign-sync.md)内同步CRM营销活动
>* [将CRM营销活动映射到 [!DNL Marketo Measure] 渠道/子渠道](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
>* [从销售活动创建接触点](/help/channel-tracking-and-setup/salesforce-activities-attribution.md)
>* [活动常见问题解答和将活动接触点映射到渠道/子渠道](/help/channel-tracking-and-setup/activities-attribution-faq.md)
