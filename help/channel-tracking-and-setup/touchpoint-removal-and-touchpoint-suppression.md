...
![从与下一个](assets/touchpoint-settings-10.png)相关的运算符列表中进行选择
...
![或者，在组外添加新的语句以使用“OR”逻辑](assets/touchpoint-settings-11.png)

`3)`如果您的规则变得复杂，并且您需要重新创建组并对每个语句进行细微更改，请使用[!UICONTROL Clone]选项来简化操作。

![3)如果规则变得复杂，您需要重新创建组](assets/touchpoint-settings-6.png)

如果你犯了错，别担心。 您也可以删除语句的单个行或整个组。

![如果出错，请不要担心。 您可以删除单个行](assets/touchpoint-settings-7.png)
