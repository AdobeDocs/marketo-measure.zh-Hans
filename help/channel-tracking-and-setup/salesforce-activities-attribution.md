---
description: 面向Marketo Measure用户的Salesforce活动归因指南
...
![Marketo Measure Salesforce Activities集成带来了特定任务和](assets/activities-attribution-10.png)
...
![如果要为每个销售代表设置唯一的Campaign](assets/activities-attribution-11.png)
...
![规则用作过滤器，告诉我们哪些记录是](assets/activities-attribution-12.png)
...
![在安装包时，Marketo Measure包含自定义Buyer Touchpoint](assets/activities-attribution-13.png)

不要忘记为任务或事件设置不同的规则。 您必须知道销售团队使用哪个对象来记录其活动。

![不要忘记为任务或事件设置不同的规则。 您](assets/activities-attribution-5.png)
...
![最后但同样重要的是，您可以选择输入成本](assets/activities-attribution-9.png)
