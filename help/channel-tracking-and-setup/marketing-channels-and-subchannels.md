---
description: 面向Marketo Measure用户的营销渠道和子渠道指南
title: 营销渠道和子渠道
...
要根据销售线索的UTM参数自定义销售线索将归入哪个“存储桶”，您可以使用渠道规则。 有关设置和维护渠道规则的更多信息，[单击此处](/help/channel-tracking-and-setup/online-custom-channel-setup.md)。

了解如何设置[在线渠道](/help/channel-tracking-and-setup/online-custom-channel-setup.md)和[离线渠道](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)以及它们之间的区别。
