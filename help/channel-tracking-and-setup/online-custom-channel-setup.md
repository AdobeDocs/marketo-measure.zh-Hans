...
![第一步是从](assets/online-channels-1.png)下载自定义渠道电子表格

电子表格有七列：

![电子表格有七列：](assets/online-channels-2.png)
...
![行表示规则和Marketo Measure](assets/online-channels-3.png)的顺序
...
![Marketo Measure附带12个默认渠道供您使用。 这些](assets/online-channels-4.png)
...
![规则的每个参数或组件都单独映射到](assets/online-channels-5.png)
...
![存在默认渠道“其他”以捕获不符合的数据](assets/online-channels-6.jpg)
