...
![当潜在客户或联系人直接添加到营销活动时，他们被输入](assets/dynamics-lists-1.png)
...
![要在接触点历程中包括这些记录，有几条记录](assets/dynamics-lists-10.png)

您可以选择在营销策划中包含具有营销策划响应的所有记录，或者仅包含响应为“感兴趣”的记录，或者在默认情况下，您根本不能包含营销策划响应。 您可以将此字段留空或明确选择将其排除。

[!DNL Marketo Measure]不支持自定义响应值。

![Marketo Measure不支持自定义响应值。](assets/dynamics-lists-2.png)

这些是Campaign响应的库存响应值：

![这些是促销活动响应的Stock响应值：](assets/dynamics-lists-3.png)
...
![使用此字段的一个常见示例是列表](assets/dynamics-lists-4.png)的事件
...
![Marketo Measure仅支持静态营销列表。 我们不支持](assets/dynamics-lists-5.png)
...
![要为接触点启用营销列表，有单独的设置](assets/legacy-processes-10.png)
...
![营销列表的接触点日期通常是创建的ListMember](assets/dynamics-lists-6.png)
...
![对于每种营销活动类型，都可以映射到渠道和](assets/dynamics-lists-7.png)

![对于每种营销活动类型，都可以映射到渠道和](assets/dynamics-lists-8.png)
