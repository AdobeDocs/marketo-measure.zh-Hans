---
description: 面向Marketo Measure用户的在线渠道指南最佳实践
title: 在线渠道的最佳实践
...
保存和处理在线渠道规则后，它们会不断工作以存储您的数字接触点。 但是，某些更改或情况会导致您需要查看联机渠道设置。[!DNL Marketo Measure] 建议您每六个月审查一次在线渠道规则。 这可确保您的[!DNL Marketo Measure]数据与联机渠道/子渠道的内部定义以及UTM的使用保持一致。
...
>[!MORELIKETHIS]
> [联机渠道设置](/help/channel-tracking-and-setup/online-custom-channel-setup.md)
