---
description: 面向Marketo Measure用户的离线自定义渠道设置指南
title: 脱机自定义渠道设置
...
![电子表格有三列：](assets/offline-channels-1.png)
...
![SFDC促销活动类型将显示在“脱机渠道”的选项卡中，已列出](assets/offline-channels-10.jpg)
...
![您可以在](assets/offline-channels-11.png)中创建渠道/子渠道映射
...
![以下是Marketo Measure不支持的逻辑示例](assets/offline-channels-12.png)

在上述场景中，您将需要创建一个唯一的促销活动类型，因为您不能将相同的促销活动类型映射到两个不同的子渠道。 相反，您需要设置如下所示的唯一类型：

![在上述方案中，您将需要创建一个唯一的营销活动](assets/offline-channels-13.png)

渠道映射中必须包含任何现有的营销活动类型，并应将“NULL”添加为渠道。

请花些时间查阅[!DNL Salesforce]，以确定要包含的现有记录类型的数量和性质，以及是否需要根据上述信息创建其他营销活动。 填写完所有必要信息后，即可上传。

了解有关[脱机同步 [!DNL Salesforce] 营销活动与 [!DNL Marketo Measure]](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)的详细信息。
...
![处理在线活动营销活动的另一个技巧是映射](assets/offline-channels-14.png)
...
![使用自定义规则编辑和更新电子表格后，](assets/offline-channels-20.png)
