...
然后，![潜在客户1转换为具有机会的联系人，](assets/boomerang-stages-18.png)

**方案2：潜在客户的回访式接触点和自定义阶段**

在此方案中，客户选择只跟踪带有回滚接触点的&#x200B;**SQL阶段**。 仍在跟踪MQL和SAL阶段，但具有[!DNL Marketo Measure]自定义阶段功能。

![在此方案中，客户只选择跟踪SQL](assets/boomerang-stages-19.png)
...
![此方案使用与方案2相同的条件。 客户具有](assets/boomerang-stages-20.png)
...
![在此方案中，客户已选择跟踪MQL和](assets/boomerang-stages-21.png)
...
![商机中包含来自Lead 1的所有接触点，来自](assets/boomerang-stages-22.png)
...
![在此方案中，客户已选择跟踪MQL、SQL、](assets/boomerang-stages-23.png)
...
![在此方案中，客户已选择跟踪MQL、SQL、](assets/boomerang-stages-25.png)
...
![在此方案中，客户已选择跟踪演示和](assets/boomerang-stages-25.png)
