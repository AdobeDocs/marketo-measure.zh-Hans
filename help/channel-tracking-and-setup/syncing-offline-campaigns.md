...
可能很难准确地跟踪离线营销活动，并且很难了解它们与您的数字营销工作的对比情况。[!DNL Marketo Measure] 允许您在[!DNL Salesforce]中跟踪接触点并将其归因到离线营销活动，即使在事件发生几周后才会创建[!DNL Salesforce]营销活动的情况下也是如此。
...
![您的上传日期将晚于会议日期三周。](assets/dynamics-lists-1.png)
...
![请确保在为](assets/dynamics-lists-10.png)启用接触点之前更新接触点日期
...
![要在Salesforce中创建营销活动，请导航到营销活动](assets/dynamics-lists-2.png)

创建此营销活动时，单击“[!UICONTROL Enable Buyer Touchpoints]”字段，然后从选择列表中选择以下选项之一：

![创建此营销活动时，请单击“启用买方接触点”](assets/dynamics-lists-3.png)
