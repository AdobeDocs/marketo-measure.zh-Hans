...
>[!NOTE]
>
>[关于如何设置回音符阶段的说明](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md)。
...
![如果没有Boomerang阶段（“之前”），您只能看到最近的MQL](assets/boomerang-stages-18.png)
...
![使用以下示例，此Marketo Measure帐户已包含MQL](assets/boomerang-stages-19.png)
...
由于[!DNL Marketo Measure]具有的处理限制，该上限适用于Data Warehouse和CRM。 Data Warehouse还将看到每个阶段十个接触点的限制。
