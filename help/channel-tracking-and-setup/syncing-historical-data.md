...
![若要同步联机历史数据，必须将数据整理到Salesforce中](assets/dynamics-lists-1.png)
...
![如果数据存储在其他位置（例如仍位于营销中）](assets/dynamics-lists-10.png)
...
有关同步营销列表的详细信息，请参阅此处： [[!DNL Dynamics] 促销活动和营销列表](/help/channel-tracking-and-setup/dynamics-campaigns-and-marketing-lists.md)
