...
1. 前往 [!UICONTROL Stage Mapping]。 在标题为“[!UICONTROL Boomerang]”的列下，选择要跟踪的阶段旁边的框。

   ![1. 转到阶段映射。 在标题为“Boomerang”的列下，](assets/boomerang-stages-18.png)

1. 转到[!UICONTROL Attribution Settings]选项卡并输入您希望看到的每个阶段的接触点数。 最多允许10个。 缺省设置为1。

   ![1. 转到“归因设置”选项卡并输入数字](assets/boomerang-stages-19.png)
