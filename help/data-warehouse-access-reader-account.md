...
1. 在[!DNL Marketo Measure]中，单击页面顶部的&#x200B;**[!UICONTROL My Account]** > **[!UICONTROL Settings]**。
   ...
   ![1. 在Marketo Measure页面顶部，单击](assets/data-account-7.png)

1. 在左侧菜单的“安全”下，单击&#x200B;**[!UICONTROL Data Warehouse]**。

   ![1. 在左侧菜单的“安全”下，单击Data Warehouse。](assets/data-account-8.png)

1. 此页面包含指向Snowflake Data Warehouse和用户名的链接。

   ![1. 此页面具有指向您的Snowflake Data Warehouse和](assets/data-account-9.png)的链接
...
1. 登录后，单击页面顶部的&#x200B;**[!UICONTROL Worksheets]**。
   ...
   ![1. 登录后，单击](assets/data-account-6.png)顶部的工作表

1. BIZIBLE_ROI_V3数据库对象位于屏幕左侧。 在查询窗口顶部的下拉选项中输入仓库、数据库和方案。 每个选项应只有一个选项。 现在，您可以在Snowflake查询编辑器中执行查询了。

   ![1. BIZIBLEROIV3数据库对象位于](assets/data-account-4.png)的左侧
...
![我们仅在用户界面中显示临时密码。 电子邮件将](assets/data-account-3.png)

![我们仅在用户界面中显示临时密码。 电子邮件将](assets/data-account-1.png)
