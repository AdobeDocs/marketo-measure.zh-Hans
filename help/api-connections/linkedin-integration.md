...
![LinkedIn广告格式类型显示单个图像广告、视频广告和轮播选项，并支持Lead Gen Forms](assets/one.png)
...
![在自动标记进程之前显示四个创意及其关联共享的图表](assets/two.png)
...
![图表显示在自动标记和存档过程后创建的具有唯一共享的新创意](assets/three.png)
...
![显示具有反向链接列的LinkedIn付费渠道定义的营销渠道规则配置](assets/four.png)
...
![LinkedIn广告，在要标记的描述中显示目标URL和缩短的URL](assets/five.png)
...
![LinkedIn营销活动管理器显示在新选项卡中打开的广告，共享ID显示在URL](assets/six.png)中
