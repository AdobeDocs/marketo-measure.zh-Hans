...
* 如果在跟踪模板（如Kenshoo或Marin）中找到第三方重定向，则[!DNL Marketo Measure]将不执行任何操作。 相反，您必须在帐户](/help/api-connections/how-bid-management-tools-affect-marketo-measure.md){target="_blank"}中向第三方工具[添加 [!DNL Marketo Measure] 参数。
