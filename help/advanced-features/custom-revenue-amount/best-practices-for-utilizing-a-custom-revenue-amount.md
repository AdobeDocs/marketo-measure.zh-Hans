---
description: 为Marketo Measure用户使用自定义收入额指南的最佳实践
title: 利用自定义收入额的最佳实践
...
>* [多货币概述](/help/advanced-features/multi-currency/overview.md)
>* [多货币设置](/help/advanced-features/multi-currency/settings.md)
