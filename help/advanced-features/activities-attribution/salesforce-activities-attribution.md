...
![设置选项卡，显示归因规则的“活动”配置页面](assets/1.png)
...
![Campaign Name字段，带有出站销售量的动态替换参数示例](assets/2.png)
...
![活动规则配置界面显示带有and/or语句选项的筛选条件](assets/3.png)
...
![Buyer Touchpoint日期字段选择，显示标准和自定义日期字段选项](assets/4.png)

不要忘记为任务或事件设置不同的规则。 您必须知道销售团队使用哪个对象来记录其活动。

![对象类型选择器，显示活动规则的“任务”和“事件”选项](assets/5.png)
...
![显示具有通配符运算符选项的营销活动映射的营销渠道配置页面](assets/6.png)
...
![用于按月输入渠道成本的营销支出上传界面，ROI跟踪为](assets/7.png)
