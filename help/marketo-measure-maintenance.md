...
通过阅读[本文](/help/marketing-channel-costs.md)，刷新您关于如何上载成本信息的内存。
...
参考[本文](/help/channel-tracking-and-setup/online-custom-channel-setup.md)进行联机设置，[参考本文](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)进行脱机设置，并参考我们客户策划的最佳实践列表：
...
如果您使用的是任何自定义[!UICONTROL Lead]、[!UICONTROL Contact]或[!UICONTROL Opportunities]阶段，则您可能还自定义了这些阶段映射到的管道部分，以及这些阶段是否包含在自定义归因模型中。 每季度访问一次[本文](/help/channel-tracking-and-setup/custom-attribution-model-and-setup.md)以刷新自定义阶段映射上的内存，并确保准确跟踪自定义阶段。
...
有关[!DNL Marketo Measure]机器学习模型的详细信息，请查看[本文](/help/channel-tracking-and-setup/machine-learning-model-faq.md)。
