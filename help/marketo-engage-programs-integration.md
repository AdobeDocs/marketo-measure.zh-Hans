...
1. 要开始设置Marketo程序中的规则，请导航到&#x200B;**[!UICONTROL My Account]** > **[!UICONTROL Settings]** > **[!UICONTROL Programs]**。 单击&#x200B;**+**&#x200B;图标开始创建您的第一条规则。
   ...
   ![1. 要开始在Marketo程序中设置规则，请导航到](assets/marketo-engage-programs-01.png)

   ![1. 要开始在Marketo程序中设置规则，请导航到](assets/marketo-engage-programs-06.png)

1. 如果有助于跟踪规则，您可以选择为规则设置名称。 您首先要从“计划”和“计划成员资格”字段列表中选择要定义规则的字段。 通过选择要检查的运算符和预期值继续构建规则。

   ![1. 您可以选择为规则设置名称，如果是](assets/marketo-engage-programs-07.png)

1. 在同一框内添加其他语句以在规则中设置“and”标准，或者单击框外的+图标以设置“or”语句。

   ![1. 在同一框内添加另一语句以设置](assets/bizible-discover-1.png)

1. 选择应该使用哪个日期或日期/时间字段来映射到接触点日期。 要查看Marketo中可用的值列表，请输入花括号`{`，我们将显示可用的字段。

   ![1. 选择应该使用哪个日期或日期/时间字段来映射](assets/marketo-engage-programs-02.png)

   >[!NOTE]
   >
   >如果规则要捕获活动日期，或项目群成员达到特定状态的日期，您将需要利用[!DNL Marketo Engage]活动集成并为“更改进展中的状态”活动类型设置规则。

   ![如果规则要捕获活动日期或日期](assets/bizible-discover-2.png)
...
1. 要运行测试，请单击&#x200B;**[!UICONTROL TEST]**&#x200B;按钮，如下所示。
   ...
   ![1. 要运行测试，请单击“测试”按钮，如下所示](assets/marketo-engage-programs-03.png)

1. 此时将显示一个模式窗口，您可以在其中从Marketo输入项目ID。

   ![1. 将显示一个模式窗口，您可以在其中输入程序](assets/marketo-engage-programs-04.png)
   ...
   ![规则以5000个成员的样本大小运行。 如果您的](assets/marketo-engage-programs-05.png)

   您可以单击成员计数以查看符合计划条件的Marketo人员ID列表。

   ![您可以单击“成员计数”查看Marketo列表](assets/marketo-engage-activities-08.png)
...
1. 首先选择应映射到值的渠道，然后（可选）选择子渠道。 完成后，单击底部的&#x200B;**[!UICONTROL Save]**。
   ...
   ![1. 首先选择应映射到值的渠道，然后](assets/marketo-engage-programs-08.png)
