...
![客户历程时间线显示四个里程碑接触点：首次联系、潜在客户创建、商机创建以及成功闭关](assets/overview-resources-8.png)
...
![首次联系模型图显示了100%归因点数到Adwords渠道](assets/overview-resources-9.png)
...
![潜在客户创建模型图显示了LinkedIn渠道的100%归因点数](assets/overview-resources-10.png)
...
![U形模型图显示50%的点数归于Adwords，50%的点数归于LinkedIn](assets/overview-resources-11.png)
...
![W形模型图显示30%的点数分别归于FT、LC和OC接触点，10%归于中间接触点](assets/overview-resources-12.png)
...
![完整路径模型图显示为FT、LC、OC和CW接触点各有22.5%的点数，中间接触点各有10%的点数](assets/overview-resources-13.png)
