...
对于每个Marketo Measure字段都与之相关的对象，请[单击此处](/help/configuration-and-setup/marketo-measure-object-and-field-taxonomy.md)。
...
此字段显示接触点所属的营销活动或营销渠道的一般组（即付费搜索、直接、社交等）。 根据Marketo Measure应用程序中渠道的设置方式，对接触点进行分组。 有关营销渠道或如何设置渠道的详细信息，[单击此处](/help/channel-tracking-and-setup/online-custom-channel-setup.md)。
...
![此字段显示营销渠道，以及](assets/overview-resources-16.png)的子渠道
