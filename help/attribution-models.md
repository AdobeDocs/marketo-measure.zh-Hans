...
![非交易日交易(CW)](assets/overview-resources-8.png)
...
![说Kate第一次通过Adwords广告访问www.adobe.com](assets/overview-resources-9.png)
...
![继续上一个示例，在Kate第一次通过www.adobe.com访问](assets/overview-resources-10.png)之后
...
![Kate第一次通过Adwords广告访问www.adobe.com将获得50%](assets/overview-resources-11.png)
...
![Hillary收到一封电子邮件，其中包含指向定价页的链接和](assets/overview-resources-12.png)
...
![机会创建后，Kate、Austin和Hillary决定推介Marketo](assets/overview-resources-13.png)
