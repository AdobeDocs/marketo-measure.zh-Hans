...
![在Salesforce中显示PostLC接触点的潜在客户记录](assets/1.png)
...
![PostLC接触点列表上限为最近提交的四次](assets/2.png)
...
1. 输入要推送到潜在客户的postLC接触点数，然后单击&#x200B;**[!UICONTROL Save]**。
   ...
   ![要设置PostLC接触点限制的潜在客户设置页面](assets/3.png)
...
1. 输入要推送到联系人的postLC接触点数，然后单击&#x200B;**[!UICONTROL Save]**。
   ...
   ![用于设置PostLC接触点限制的联系人设置页面](assets/4.png)
