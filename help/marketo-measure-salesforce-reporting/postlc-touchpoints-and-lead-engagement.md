---
description: 了解如何为潜在客户和联系人创建、更新和限制PostLC接触点
...
![Marketo Measure潜在客户创建后(PostLC)接触点可供使用](assets/additional-functionality-1.png)的客户使用
...
![PostLC接触点是动态的。 作为潜在客户或联系人继续提交](assets/additional-functionality-2.png)
...
1. 在[!DNL Marketo Measure]experience.adobe.com/marketo-measure[登录到您的](https://experience.adobe.com/marketo-measure){target="_blank"}帐户并转到[!UICONTROL Settings]。

1. 在CRM下，选择&#x200B;**[!UICONTROL Leads]**。

1. 输入要推送到潜在客户的postLC接触点数，然后单击&#x200B;**[!UICONTROL Save]**。

   ![1. 输入您要推送到](assets/additional-functionality-3.png)的postLC接触点数
...
1. 输入要推送到联系人的postLC接触点数，然后单击&#x200B;**[!UICONTROL Save]**。
   ...
   ![1. 输入您要推送到](assets/additional-functionality-4.png)的postLC接触点数
