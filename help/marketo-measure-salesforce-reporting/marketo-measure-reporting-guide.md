...
为基于Opportunity的量度提供最佳insight的[归因模型](/help/attribution-models.md)包括：
...
![上面的屏幕截图显示了过去3](assets/bizible-guide-3.png)年的营销支出数据
...
![筛选您知道的营销渠道、子渠道和/或营销活动](assets/bizible-guide-4.png)
