...
1. 转到[!UICONTROL Setup]并展开[!UICONTROL Manage Users]分组以选择配置文件。
   ...
   ![1. 转到“设置”并展开“管理用户”分组](assets/additional-functionality-1.png)

1. 选择我们连接到的用户的配置文件。

1. 搜索查看和编辑已转化商机的权限。

   ![1. 搜索查看和编辑已转化商机的权限。](assets/additional-functionality-2.png)

1. 选中方框，可启用查看和编辑已转化商机的权限。

   ![1. 选中该框可启用查看和编辑](assets/additional-functionality-3.png)的权限
