...
![上个月按渠道划分的归因收入明细是什么？](assets/attributed-dashboard-4.png)
...
![单击每个渠道旁边的“+”图标以显示划分依据](assets/attributed-dashboard-5.png)
...
![单击分支以更深入地了解后续层次结构层。](assets/attributed-dashboard-6.png)
