...
![已实现ROI：已实现归因收入除以过滤日期中的成本](assets/roi-dashboard-9.png)
...
![是否存在异常高的或异常低的异常值通道或子通道](assets/roi-dashboard-8.png)
...
![已实现ROI的趋势与任何重要的营销活动有何关系](assets/roi-dashboard-7.png)
...
![特定渠道的成本如何随时间变化？](assets/roi-dashboard-6.png)
...
![哪些营销渠道（渠道、子渠道或营销活动）与其他渠道相比资金似乎不足？](assets/roi-dashboard-5.png)
