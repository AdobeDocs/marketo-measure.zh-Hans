...
1. 单击页面右上角的帐户，然后单击“切换目录”导航，然后选择相应的租户，以选择Azure AD租户。 如果您的帐户下只有一个Azure AD租户，或者您已选择适当的Azure AD租户，请跳过此步骤。
   ...
   ![1. 在](assets/bizible-taxonomy-1.png)中单击您的帐户以选择Azure AD租户

1. 在搜索栏中搜索“[!DNL Azure Active Directory]”，然后单击要打开的名称。

   ![1. 在搜索栏和](assets/microsoft-guide-1.png)中搜索“Azure Active Directory”

1. 单击左侧菜单中的&#x200B;**[!UICONTROL App Registrations]**。

   ![1. 单击左侧菜单中的“应用程序注册”。](assets/microsoft-guide-2.png)

1. 单击顶部的&#x200B;**[!UICONTROL New Registration]**。

   ![1. 单击顶部的“新建注册”。](assets/microsoft-guide-3.png)
...
1. 单击左侧菜单中的&#x200B;**[!UICONTROL Authentication]**。
   ...
   ![1. 单击左侧菜单中的“身份验证”。](assets/microsoft-guide-4.png)
...
1. 将[!DNL Marketo Measure]重定向URL： `https://apps.bizible.com/OAuth2`和`https://apps.bizible.com/OAuth2?identityOnly=true`添加到重定向URL列表中。
   ...
   ![1. 将Marketo Measure重定向URL： https://apps.bizible.com/OAuth2和https://apps.bizible.com/OAuth2?identityOnly=true添加到](assets/microsoft-guide-5.png)

1. 导航到API权限选项卡，并确保为应用程序分配了正确的权限。

   ![1. 导航到“API权限”选项卡，并确保](assets/microsoft-guide-6.png)

1. 从此处，在搜索框中输入“[!UICONTROL enterprise]”，然后单击&#x200B;**[!UICONTROL Enterprise Applications]**。

   ![1. 在此处，在搜索框中输入“enterprise”，然后单击](assets/microsoft-guide-7.png)

1. 再次从应用程序列表中查找并打开您的新应用程序。

1. 在“权限”选项卡中，单击&#x200B;**[!UICONTROL Grant Admin Consent for (instance name)]**。

   ![1. 在“权限”选项卡中，单击（实例](assets/microsoft-guide-8.png)）的“授予管理员同意”

1. 单击 **[!UICONTROL Accept]**。

   ![1. 单击“接受”。](assets/microsoft-guide-9.png)

1. 在“[!UICONTROL Users and Groups]”选项卡中，确保将有效的“用户和组”分配给应用程序。

   ![1. 在“用户和组”选项卡中，确保](assets/microsoft-guide-10.png)
...
1. 首次设置Dynamics连接时，请按照[本文](/help/microsoft-dynamics-crm-installation-guide.md)中“CRM as a Data Provider”部分的步骤1-5操作。
...
![b。客户端密钥是在Azure门户](assets/microsoft-guide-11.png)中创建的应用程序密钥
...
1. 单击密钥后，会出现一个弹出窗口，提示您输入客户端ID、客户端密钥和应用程序ID URI，类似于注册流程。
   ...
   ![1. 单击该键时，会出现一个弹出窗口，您就是](assets/microsoft-guide-12.png)
