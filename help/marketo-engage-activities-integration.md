...
1. 首先，根据活动类型，您可能需要设置稍后可用于渠道映射的[!DNL Marketo Measure]促销活动名称。[!DNL Marketo Measure] 营销活动名称可以在多个规则中重复使用。 这有助于在单个渠道规则中使用更广泛的名称。 并非所有活动类型都包含Marketo程序，因此第一步，需要指定一个名称。
